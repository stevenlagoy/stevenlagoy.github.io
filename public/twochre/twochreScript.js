...
const scorePointValues = {
    0: "gfx/score_0040.png",
    0.5: "gfx/score_05.png",
    1: "gfx/score_10.png",
    1.5: "gfx/score_15.png",
    2: "gfx/score_20.png",
    2.5: "gfx/score_25.png",
    3: "gfx/score_30.png",
    3.5: "gfx/score_35.png"
};
// CREATE SUITS
const suits = [
    new Suit("hearts", "red"),
...
/* CREATE DECKS */
const noCard = new Card(null, 0, "gfx/cards/blank.png");
const cardBack = new Card(null, 0, "gfx/cards/card_back.png");
const cards = [
    new Card(suits[0], 2,  "gfx/cards/2_of_hearts.png"),
    new Card(suits[0], 3,  "gfx/cards/3_of_hearts.png"),
    new Card(suits[0], 4,  "gfx/cards/4_of_hearts.png"),
    new Card(suits[0], 5,  "gfx/cards/5_of_hearts.png"),
    new Card(suits[0], 6,  "gfx/cards/6_of_hearts.png"),
    new Card(suits[0], 7,  "gfx/cards/7_of_hearts.png"),
    new Card(suits[0], 8,  "gfx/cards/8_of_hearts.png"),
    new Card(suits[0], 9,  "gfx/cards/9_of_hearts.png"),
    new Card(suits[0], 10, "gfx/cards/10_of_hearts.png"),
    new Card(suits[0], 11, "gfx/cards/jack_of_hearts.png"),
    new Card(suits[0], 12, "gfx/cards/queen_of_hearts.png"),
    new Card(suits[0], 13, "gfx/cards/king_of_hearts.png"),
    new Card(suits[0], 14, "gfx/cards/ace_of_hearts.png"),
    new Card(suits[1], 2,  "gfx/cards/2_of_diamonds.png"),
    new Card(suits[1], 3,  "gfx/cards/3_of_diamonds.png"),
    new Card(suits[1], 4,  "gfx/cards/4_of_diamonds.png"),
    new Card(suits[1], 5,  "gfx/cards/5_of_diamonds.png"),
    new Card(suits[1], 6,  "gfx/cards/6_of_diamonds.png"),
    new Card(suits[1], 7,  "gfx/cards/7_of_diamonds.png"),
    new Card(suits[1], 8,  "gfx/cards/8_of_diamonds.png"),
    new Card(suits[1], 9,  "gfx/cards/9_of_diamonds.png"),
    new Card(suits[1], 10, "gfx/cards/10_of_diamonds.png"),
    new Card(suits[1], 11, "gfx/cards/jack_of_diamonds.png"),
    new Card(suits[1], 12, "gfx/cards/queen_of_diamonds.png"),
    new Card(suits[1], 13, "gfx/cards/king_of_diamonds.png"),
    new Card(suits[1], 14, "gfx/cards/ace_of_diamonds.png"),
    new Card(suits[2], 2,  "gfx/cards/2_of_spades.png"),
    new Card(suits[2], 3,  "gfx/cards/3_of_spades.png"),
    new Card(suits[2], 4,  "gfx/cards/4_of_spades.png"),
    new Card(suits[2], 5,  "gfx/cards/5_of_spades.png"),
    new Card(suits[2], 6,  "gfx/cards/6_of_spades.png"),
    new Card(suits[2], 7,  "gfx/cards/7_of_spades.png"),
    new Card(suits[2], 8,  "gfx/cards/8_of_spades.png"),
    new Card(suits[2], 9,  "gfx/cards/9_of_spades.png"),
    new Card(suits[2], 10, "gfx/cards/10_of_spades.png"),
    new Card(suits[2], 11, "gfx/cards/jack_of_spades.png"),
    new Card(suits[2], 12, "gfx/cards/queen_of_spades.png"),
    new Card(suits[2], 13, "gfx/cards/king_of_spades.png"),
    new Card(suits[2], 14, "gfx/cards/ace_of_spades.png"),
    new Card(suits[3], 2,  "gfx/cards/2_of_clubs.png"),
    new Card(suits[3], 3,  "gfx/cards/3_of_clubs.png"),
    new Card(suits[3], 4,  "gfx/cards/4_of_clubs.png"),
    new Card(suits[3], 5,  "gfx/cards/5_of_clubs.png"),
    new Card(suits[3], 6,  "gfx/cards/6_of_clubs.png"),
    new Card(suits[3], 7,  "gfx/cards/7_of_clubs.png"),
    new Card(suits[3], 8,  "gfx/cards/8_of_clubs.png"),
    new Card(suits[3], 9,  "gfx/cards/9_of_clubs.png"),
    new Card(suits[3], 10, "gfx/cards/10_of_clubs.png"),
    new Card(suits[3], 11, "gfx/cards/jack_of_clubs.png"),
    new Card(suits[3], 12, "gfx/cards/queen_of_clubs.png"),
    new Card(suits[3], 13, "gfx/cards/king_of_clubs.png"),
    new Card(suits[3], 14, "gfx/cards/ace_of_clubs.png"),
    new Card("red", 0, "gfx/cards/red_joker.png"),
    new Card("black", 0, "gfx/cards/black_joker.png")
];
