        ...
        <section className={styles.aboutMe} id="about-me">
            ...
            <div className={styles.bio}>
                <div className={styles.bioText}>
                    ...
                    <p>
                        ...
                        have been fascinated by technology forever and have been coding for 10 years
            ...
            <div className={styles.bio}>
                <div className={styles.bioText}>
                    <h2>Now</h2>
                    <p>
                        In Spring of 2026, I earned my bachelor's degree in Computer Science at
                        <a href="https://www.pfw.edu/">Purdue University Fort Wayne</a> with an honors
                        certificate and a cumulative GPA of 3.77. I am currently a graduate student at PFW,
                        and I will graduate in Spring of 2027 with a
                        <a href="https://www.pfw.edu/academics-research/majors-minors/computer-science-ms">
